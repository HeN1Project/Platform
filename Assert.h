...
# define HELIUM_COMPILE_ASSERT_JOIN(X, Y)
# define HELIUM_COMPILE_ASSERT_DO_JOIN(X, Y)
# define HELIUM_COMPILE_ASSERT_DO_JOIN2(X, Y)
# define HELIUM_COMPILE_ASSERT(exp)
#endif
